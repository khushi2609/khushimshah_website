        ...
        <article className="prose prose-lg max-w-none">
          ...
          <p className="text-gray-800 mb-6">
            ...
            <div className="relative h-[500px] rounded-lg overflow-hidden">
              <Image
                src="/blog/jmrc/simulator.jpg"
                alt="DCTC Training Center"
                fill
                className="object-cover"
                sizes="(max-width: 2048px) 100vw, 450px"
              />
            </div>
          <h2 className="text-2xl font-bold text-accent mt-8 mb-4">
          ...
          <div className="relative w-full h-[450px] my-6 rounded-lg overflow-hidden">
            <Image
              src="/blog/jmrc/Uebungsdorf.jpg"
              alt="Breach Exercise at Uebungsdorf"
              fill
              className="object-cover"
              sizes="(max-width: 1024px) 100vw, 800px"
            />
          ...
          <div className="grid grid-cols-2 gap-4 my-6">
            <div className="relative h-[250px] rounded-lg overflow-hidden">
              <Image
                src="/blog/jmrc/Interview.jpg"
                alt="Interview with SSG Mayor"
                fill
                className="object-cover"
            ...
            <div className="relative h-[250px] rounded-lg overflow-hidden">
              <Image
                src="/blog/jmrc/helicopterTour.jpg"
                alt=""
                fill
                className="object-cover"
                sizes="(max-width: 1024px) 50vw, 400px"
